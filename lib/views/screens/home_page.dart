...
String applicationId = "22c6e068";
String applicationKey = "0393d16cd4089e01f0ede4d1647cc24e";

getRecipes(String query) async {
String url = "https://api.edamam.com/search?q=chicken&app_id=22c6e068&app_key=0393d16cd4089e01f0ede4d1647cc24e&from=0&to=3&calories=591-722&health=alcohol-free";
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: Text('Recipe Factory', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w700)),
